...
namespace NotikaIdentityEmail.Controllers
{
    public class RegisterController : Controller
    {
        ...
        public async Task<IActionResult> CreateUser(RegisterUserViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                //Buraya mail kodları gelecek (mppc ifbi mnrw dpeb)

                MimeMessage mimeMessage = new MimeMessage();

                MailboxAddress mailboxAddressFrom = new MailboxAddress("Admin", "helinbora2121@gmail.com");
                ...
                client.Authenticate("helinbora2121@gmail.com", "mppcifbimnrwdpeb");
